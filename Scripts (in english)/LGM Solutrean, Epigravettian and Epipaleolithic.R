...
LGM.Sites <- LGM.Sites %>% 
  mutate(
    Complex = factor(Complex, 
                     ...
                     labels = c("Solutrean", "Epigravettian", "Epipaleolithic")))
...
ggmap(Europe.Levant2) +
  ...
  geom_label(aes(x = 15, y = 54, label = "Europe and the mediterranean Levant during the Last Glacial Maximum"),
...
ggsave(
  "Images-english/LGM Solutrean, Epigravettian and Epipaleolithic v1.jpg",
  device = "jpg",
  dpi = 1200,
  width = 25,
  height = 16,
...
ggmap(Europe.Levant2) +
  ...
  ggtext::geom_richtext(aes(x = 27, y = 31.5, label = "E p i p a l e o l i t h i c"),
...
ggsave(
  "Images-english/LGM Solutrean, Epigravettian and Epipaleolithic v2.jpg",
  device = "jpg",
  dpi = 1200,
  width = 25,
  height = 16,
