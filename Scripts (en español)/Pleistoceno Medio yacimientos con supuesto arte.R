...
#### Yacimientos con supesto arte en el Pleistoceno Medio ####
Sites <- data.frame(
  ...
  Longitude.DD = c(111.3578,	
                   ...
                   -11.103889,
                   35.766389),
  Type = c("Grabados", "Grabados", "Venus", "Venus"))

#### Mapa de yacimeintos con supuesto arte en el Pleistoceno Medio ####
ggmap(Art.Mid.Ple) +
  theme_map() +
...
ggsave(
  "Images-español/Pleistoceno Medio yacimientos con supuesto arte.jpg",
  device = "jpg",
  dpi = 1200,
  width = 23,
  height = 14,
