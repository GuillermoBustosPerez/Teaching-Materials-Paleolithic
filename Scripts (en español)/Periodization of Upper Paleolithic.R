...
df.Climate  %>% ggplot(aes(age/1000, delta)) +
  ...
  geom_label(aes(x = 13, y = -29, label = "Magdaleniense\n16-10 Ka"),
             fill = "darkorchid1", color = 'black',
             size = 5) +
  geom_label(aes(x = 16.5, y = -33.5, label = "Magdaleniense\nInicial\n17\n-\n16\nKa"),
  ...
  geom_label(aes(x = 25, y = -31, label = "Gravetiense\n28-22 Ka"),
             fill = "darkolivegreen2", color = 'black',
             size = 5) +
  geom_label(aes(x = 33, y = -29, label = "Auriñaciense\n38-28 Ka"),
