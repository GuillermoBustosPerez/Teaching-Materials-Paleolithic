...
#### Mapa de la vista general de Proximo Oriente ####
ggmap(N.East) +
  theme_map() +
...
##### Cargar mapa centrado en el levante de Oriente Próximo ####
...
#### Mapa centrado en el levante del Próximo Oriente Neandertales y Sapiens ####
ggmap(Lev.Coast) +
  theme_map() +
  geom_point(data = NE.Cross,
             aes(longitude, latitude, fill = Remains), 
...
ggsave(
  "Images-español/Próximo Oriente Levante Neandertales y sapiens.jpg",
  device = "jpg",
  dpi = 1200,
  width = 18,
  height = 12,
