...
#### Diferencias entre la Curva O18 del Pleistoceno Medio y Superior ####
mis_last_250ka <-
...
lisiecki2005 %>% filter(Time >= 11.7 & Time <= 300) %>% 
  ...
  ggplot(aes(Time, d18O, color = Periodo)) +
...
ggsave(
  "Images-español/Curvas climáticas pleistocenos medio y superior.jpg",
  device = "jpg",
  dpi = 1200,
  width = 32,
  height = 13,
